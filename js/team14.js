var supervisor16 = [
   '<div class="col-md-12 member"><span class="member-name">Prof. Mohab<br>Hossam</span><img src="" alt="" class=" img-circle team-img"></div>',
]

var ceo16 =   '<div class="col-md-3 member"><span class="member-name">Abd Elrahman<br><span class="label label-warning">CEO</span></span><img src="" alt="" class=" img-circle team-img" style="background-color:white;"></div>';
var cto16 = [
  '<div class="col-md-3 member"><span class="member-name">Omar<br><span class="label label-primary">CTO</span></span><img src="http://i.imgur.com/sjuxYnX.jpg" alt="Omar Ibn El Khatab" class=" img-circle team-img"></div>',
