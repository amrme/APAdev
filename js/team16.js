var supervisor16 = '<div class="col-md-3 member"><span class="member-name">Prof. Ahmed<br>Naguib</span><a href="#"><img src="http://i.imgur.com/Ko02fE0.jpg" alt="Prof. Ahmed Naguib" class=" img-circle team-img"></a></div>';
var mentors16 = [
  '<div class="col-md-3 member"><span class="member-name">Moataz<br>Tarek</span><a href="#"><img src="http://i.imgur.com/RrFv4Jc.jpg" alt="Moataz Tarek" class=" img-circle team-img"></a></div>',
  '<div class="col-md-3 member"><span class="member-name">Ahmed<br>Saeed</span><a href="#"><img src="http://i.imgur.com/EsNVtoc.jpg" alt="Ahmed Saeed" class=" img-circle team-img"></a></div>',
  '<div class="col-md-3 member"><span class="member-name">Omar<br>Ibn El Khatab</span><a href="#"><img src="http://i.imgur.com/sjuxYnX.jpg" alt="Omar Ibn El Khatab" class=" img-circle team-img"></a></div>',
  '<div class="col-md-3 member"><span class="member-name">Mohamed<br>Saad</span><a href="#"><img src="http://i.imgur.com/sZjsGxI.jpg?1" alt="Mohamed Saad" class=" img-circle team-img"></a></div>',
];
